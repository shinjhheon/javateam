				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							...
							<td colspan="2"><%= bbs.getJbbsTitle().replaceAll(" ", "&nbsp;")
						...
						<tr>
							<td>작성일자</td>
							<td colspan="2"><%= bbs.getJbbsDate().substring(0,11) + bbs.getJbbsDate().substring(11,13) + "시" + bbs.getJbbsDate().substring(14,16) + "분 "%></td>
						</tr>
						<tr>
							<td>내용</td>
							<td colspan="2" style="height: 200px; text-align: Left"><%= bbs.getJbbsContent().replaceAll(" ", "&nbsp;")
							.replaceAll("<", "&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>")%></td>
						</tr>
					</tbody>
				</table>
					...
					<!-- 목록 버튼 생성 -->
				<a href="Javavvs.jsp" class="btn btn-dark pull-right">목록</a>
